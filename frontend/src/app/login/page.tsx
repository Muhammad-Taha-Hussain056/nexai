    ...
    <Box component="form" onSubmit={onSubmit} sx={{ width: '100%' }}>
      <Stack spacing={2.5}>
        ...
        <Box sx={{ mt: '-8px !important' }}>
          ...
          />
          <Typography variant="caption" sx={{ color: '#D46F35', fontWeight: 600, cursor: 'pointer', mt: 0.5, display: 'inline-block', '&:hover': { textDecoration: 'underline' } }}>
            Forgot password?
          </Typography>
        </Box>
        ...
        <Button
          ...
          sx={{
            ...
            textTransform: 'none',
            fontSize: '1rem',
            bgcolor: '#D46F35', // matching the button color slightly richer terracotta
        ...
        <Box sx={{
          ...
          <Box mb={6} mt={2}>
            ...
            <Box display="flex" gap={4} mb={6} borderBottom="1px solid #E5E7EB">
              <Typography sx={{ pb: 1.5, borderBottom: '2px solid #D46F35', fontWeight: 800, color: '#D46F35', cursor: 'pointer' }}>Sign In</Typography>
              <Typography component={Link} href="/signup" sx={{ pb: 1.5, fontWeight: 700, color: '#9CA3AF', cursor: 'pointer', textDecoration: 'none', '&:hover': { color: '#6B7280' } }}>Create Account</Typography>
            </Box>
          ...
          <Suspense fallback={<Typography>Loading form...</Typography>}>
            <LoginForm />
          </Suspense>
          ...
          <Box mt={4} width="100%">
            ...
            <Typography variant="body2" color="text.secondary" textAlign="center" mt={4} fontWeight={500}>
              ...
              <Typography component={Link} href="/signup" variant="body2" sx={{ color: '#D46F35', fontWeight: 700, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
                Create one →
              </Typography>
            </Typography>
          </Box>
